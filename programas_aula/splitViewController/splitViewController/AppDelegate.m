...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ZXYTableViewController* tableViewController = [[ZXYTableViewController alloc]init];
    
    tableViewController.detailViewController = detailViewController;
    
    UINavigationController* masterNav = [[UINavigationController alloc]initWithRootViewController:tableViewController];
